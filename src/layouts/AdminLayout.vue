 ...
 */
const opcionesMenu = [
  { name: "cursos", titulo: "Cursos", icono: "school" },
  { name: "aprendices", titulo: "Aprendices", icono: "groups" },
  { name: "registro", titulo: "Registrar usuario", icono: "how_to_reg" },
...
<template>
  ...
  <q-layout view="lHh Lpr lFf">
    ...
    <q-page-container>
      <!-- Aqui entra la vista de la ruta activa: cursos, aprendices, acerca... -->
      <router-view />
    </q-page-container>
  </q-layout>
</template>
