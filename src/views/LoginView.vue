...
const iniciarSesion = async () => {
  ...
  try {
    const respuesta = await post("/usuarios/login", {
    ...
    // El backend responde 400 con un mensaje generico a proposito:
      ...
      <q-card flat class="tarjeta">
        <q-card-section class="text-center q-pb-none">
          ...
          <p class="texto-suave text-body2">
            Inicia sesion para gestionar cursos y aprendices.
          </p>
        </q-card-section>
        ...
        <q-card-section class="text-caption texto-suave">
          ...
          Usuario creado por <code>npm run seed</code>:
          <strong>admin@sena.edu.co</strong> / <strong>123456</strong>.
          Las cuentas nuevas se crean desde adentro, en "Registrar usuario".
        </q-card-section>
      </q-card>
